...
- **Frontend**: `index.html`, `styles.css` – booking form (pickup/destination/phone), Photon geocoding, loading overlay, success/decline/timeout states.
...
- **Geocoding**: Photon (Komoot), Koh Samui bounding box.
